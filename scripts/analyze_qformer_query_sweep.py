#!/usr/bin/env python3
"""
Analyze Q-Former Query Count Sweep Results
...
def create_summary_table(results, output_dir):
    ...
    # Create table
    table = "# Q-Former Query Count Sweep Results\n\n"
...
def main():
    parser = argparse.ArgumentParser(description="Analyze Q-Former Query Sweep Results")
    ...
    print("="*50)
    print("Q-FORMER QUERY COUNT SWEEP ANALYSIS")
    print("="*50)
